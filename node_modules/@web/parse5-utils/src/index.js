/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').TreeAdapter} TreeAdapter */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').Element} Element */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').Attribute} Attribute */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').Node} Node */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').ParentNode} ParentNode */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').ChildNode} ChildNode */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').CommentNode} CommentNode */
/** @typedef {import('/web-component-designer-demo/node_modules/parse5/./lib/index.js').TextNode} TextNode */
