    ...
    if (node instanceof Element) {
      for (let a of node.attributes) {
        if (a.name.startsWith('@') && !a.value.startsWith('[[')) {
          ...
          try {
            if (a.name == "@touch:contextmenu") addTouchFriendlyContextMenu(node, this[a.value].bind(this));else {
    ...
    if (node instanceof Element) {
      ...
      for (let a of attributes) {
        if (a.name.startsWith('css:') && a.value.startsWith('[[') && a.value.endsWith(']]')) {
          ...
          if (a.name == "@touch:contextmenu") addTouchFriendlyContextMenu(node, e => this._bindingRunEval(value, repeatBindingItems, e));else {
