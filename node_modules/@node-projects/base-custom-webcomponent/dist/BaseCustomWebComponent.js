        ...
        if (node instanceof Element) {
            ...
            if (!node.children.length && !(node instanceof HTMLTemplateElement) && node.innerHTML) {
                ...
                for (let m of matches) {
                    ...
                    this._bindings.push((firstRun) => this._bindingSetNodeValue(firstRun, workingNode, null, 'innerHTML', value, repeatBindingItems, removeAttributes, host, context, false));
                    this._bindings[this._bindings.length - 1](true);
                    if (node != workingNode) {
