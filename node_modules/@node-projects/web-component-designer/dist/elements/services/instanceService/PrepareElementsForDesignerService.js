export class PrepareElementsForDesignerService {
  prepareElementsForDesigner(designItem) {
    if (designItem !== designItem.instanceServiceContainer.contentService.rootDesignItem) this._prepareElementsForDesigner([designItem.element], true);
  ...
  _prepareElementsForDesigner(elements, rootElements) {
    for (let el of elements) {
      ...
      if (el instanceof HTMLElement) {
        ...
        el.onmousedown = null;
        el.onmouseup = null;
        if (!rootElements) el.style.pointerEvents = 'none';
      }

      if (el instanceof HTMLImageElement) {
        el.draggable = false;
      } else if (el instanceof HTMLInputElement) {
        el.onmousedown = e => e.preventDefault(); //const ip = el;
