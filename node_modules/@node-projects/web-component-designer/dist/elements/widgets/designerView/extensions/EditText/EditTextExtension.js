...
export class EditTextExtension extends AbstractExtension {
  ...
  extend() {
    ...
    this.extendedItem.instanceServiceContainer.selectionService.clearSelectedElements(); //this.extensionManager.removeExtension(this.extendedItem, ExtensionType.PrimarySelection);
  ...
  _formatSelection(type) {
    ...
    this._blurTimeout = null; //const selection = <Selection>(<any>this.designerView.shadowRoot).getSelection()
