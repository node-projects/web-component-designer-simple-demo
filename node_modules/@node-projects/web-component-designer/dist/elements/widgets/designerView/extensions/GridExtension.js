...
export class GridExtension extends AbstractExtension {
  ...
  extend() {
    ...
    if (computedStyle.columnGap && computedStyle.columnGap != 'normal') xGap = Number.parseInt(computedStyle.columnGap.replace('px', ''));
    if (computedStyle.rowGap && computedStyle.rowGap != 'normal') yGap = Number.parseInt(computedStyle.rowGap.replace('px', ''));
