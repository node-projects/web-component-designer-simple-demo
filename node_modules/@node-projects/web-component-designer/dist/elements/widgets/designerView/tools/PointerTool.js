...
export class PointerTool {
  ...
  _pointerActionTypeDragOrSelect(designerView, event, currentDesignItem, currentPoint) {
    if (event.altKey) {
      ...
      if (DesignerView.getHost(currentElement) !== designerView.overlayLayer) currentDesignItem = DesignItem.GetOrCreateDesignItem(currentElement, designerView.serviceContainer, designerView.instanceServiceContainer);
    } else {
