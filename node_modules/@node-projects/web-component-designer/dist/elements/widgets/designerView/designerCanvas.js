...
export class DesignerCanvas extends BaseCustomWebComponentLazyAppend {
  ...
  zoomFactorChanged() {
    //@ts-ignore
    this._canvasContainer.style.zoom = this._zoomFactor; //this._zoomInput.value = (this._zoomFactor * 100).toFixed(0) + '%';
  ...
  _pointerEventHandler(event) {
    ...
    if (this._lastHoverDesignItem != currentDesignItem) {
      ...
      if (currentDesignItem && currentDesignItem != this.rootDesignItem && DesignerCanvas.getHost(currentElement.parentNode) !== this.overlayLayer) this.extensionManager.applyExtension(currentDesignItem, ExtensionType.MouseOver);
