  ...
  *children() {
  ...
  updateChildrenFromNodesChildren() {
    ...
    if (this.nodeType == NodeType.Element) {
      if (this.element.children && this.element.children.length === 0 && this.element.childNodes.length <= 1) this.content = this.element.textContent; //was soll das bringen???
      else {
          for (const c of this.element.childNodes) this._childArray.push(DesignItem.createDesignItemFromInstance(c, this.serviceContainer, this.instanceServiceContainer));
        }
    }
  }
