...
export class Screenshot {
  ...
  static async enableScreenshots(elementHostForVideo = document.body) {
    ...
    if (Screenshot._canvas == null) {
      ...
      elementHostForVideo.appendChild(Screenshot._video); //@ts-ignore

      Screenshot._captureStream = await navigator.mediaDevices.getDisplayMedia(gdmOptions); //@ts-ignore
