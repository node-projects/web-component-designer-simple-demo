...
export class w3color {
  ...
  static ncsToRgb(ncs) {
    ...
    if (bc !== 'N') {
      ...
      factor2 = 1 / max; //@ts-ignore

      r = parseInt(red2 * factor2 * (100 - black1) / 100 * 255, 10); //@ts-ignore

      g = parseInt(green2 * factor2 * (100 - black1) / 100 * 255, 10); //@ts-ignore
